...
comment on column order_fct.job_cnt        is 'Количество работ';
comment on column order_fct.job_price      is 'Цена работ';
comment on column order_fct.job_uk         is 'Тип работ';
